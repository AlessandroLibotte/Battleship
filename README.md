...
- RDY: Signaling the end of the sender's position phaase
...
Upon reception of any message the corresponding action is taken by either relaying the message on the inter process messaging queue or by interacting directly with the player_map or enemy_map.
